-- ✅ Modern UI พร้อม Sidebar, Toggle, Slider, Dropdown
...
logo.Image = "rbxassetid://15373539666" -- เปลี่ยนเป็นโลโก้ของคุณ
...
plantKnob.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 then draggingPlant = true end
end)

UIS.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 then draggingPlant = false end
end)
